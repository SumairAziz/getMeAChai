          ...
          >
            <div className="mx-[-10px] md:px-10 my-5">
              ...
              <p className="p-4 text-gray-200 text-md text-center font-sans flex flex-col">
                ...
                <span>Phone: +12-860-323-4457</span>
              ...
              <p className="p-4 text-gray-200 text-md text-center font-sans flex flex-col">
                ...
                <a className='hover:underline w-fit mx-auto p-1' target='blank' href='https://x.com/AZIZAZI70365568'>Twitter</a>
                <a className='w-fit mx-auto p-1' href=''>Facebook</a>
                <a className='hover:underline w-fit mx-auto p-1' target='blank' href='https://www.instagram.com/'>Instagram</a>
              </p>
            </div>
            <div
